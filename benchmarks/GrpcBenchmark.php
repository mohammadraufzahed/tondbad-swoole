...
class GrpcBenchmark
{
    ...
    public function setUp(): void
    {
        ...
        app()->routes()->post('/helloworld.Greeter/SayHello', function (Request $request, Response $response): void {
            $response->end('{}');
        });
    ...
    public function benchGrpcRouteDispatch(Blackhole $bh): void
    {
        $request = new GrpcHttpRequest(
            '',
            ['request_method' => 'POST', 'request_uri' => '/helloworld.Greeter/SayHello'],
