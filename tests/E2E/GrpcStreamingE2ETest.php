...
it('exercises server, client, and bidirectional gRPC streaming', function () {
    $port = (int) getenv('APP_GRPC_PORT') ?: 19509;
    ...
    $clientCmd = ['php', 'tests/E2E/grpc_streaming_client.php', (string) $port];
    $client = proc_open($clientCmd, $descriptors, $clientPipes, getcwd(), $env);
    stream_set_timeout($clientPipes[1], 20);
    stream_set_timeout($clientPipes[2], 20);
