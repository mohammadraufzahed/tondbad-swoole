...
it('exposes gRPC health and reflection services', function () {
    $port = (int) getenv('APP_GRPC_PORT') ?: 19510;
    ...
    $clientCmd = ['php', 'tests/E2E/grpc_health_reflection_client.php', (string) $port];
